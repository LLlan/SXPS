...
<body>
	<form action="hudongCategory/${msg }.do" name="Form" id="Form" method="post" >
	<input type="hidden" name="hudong_category_id" value="${pd.hudong_category_id}"/>
		<div id="zhongxin">
		<table>
			<tr class="info">
				<td><input type="text" name="categoryName" id="NAME" placeholder="这里输互动社区标签分类的名称" value="${pd.categoryName }" title="名称"/></td>
			</tr>
