...
<head lang="en">
 <base href="<%=basePath%>">
    ...
    <style>
		...
		.searchA {
		    background: #fff url(static/images/wm/sousuo.png) 5% center no-repeat;
...
<div style="background: url('static/images/wm/beijing.png') no-repeat; position: fixed;top:0;left:0;z-index:100;width:100%;">
    <div class="line1">
        ...
        <div class="headRight">
            ...
            <a href="javascript:void(0)" class="fenxiang"><img src="static/images/wm/fenxiang.png" /></a>
        </div>
    </div>
      <div class=" appmsg" >
        ...
        <div class="appmsg_m">
            <div class=" tgf1-1"><h5 style="font-weight: 500;"><a href="#">${shangjiaData.shopName }</a></h5></div>
            <div class="info1 tgf1-1"><a href="javascript:void(0)" style="font-size: 13px;margin-top: -6px;"><i class="iconfont icon-shengyin"></i>${shangjiaData.shopNotice}</a></div>
    ...
    <div class="youhui">
        ...
        <div class="weui-flex__item myscroll">
            <ul>
             <li><a href="javascript:void(0)" style="color: #fff;">
            ...
            <div id="food_img1" style="left: 20.7px;">
                ...
                <div class="food_img_box pop1" style="display: none;height:100%;background: url('static/images/wm/beijing.png') no-repeat;background-size:cover;">
                    ...
                    <c:if test="${mjyhList.size()>0}">
	                    <div style="color:#fff;padding: 0 0 0 10px;">
					...
					<!-- 满减配送费 -->
                    <c:if test="${mjpsfList.size()>0}">
	                    <div style="color:#fff;padding: 0 0 0 10px;">
	                        <p><img alt="" src="static/images/wm/hui.png" style="height: 15px;width: 15px;">
	                        	满减配送费:
	                        <c:forEach items="${mjpsfList}" var="mj">
	                        		满${mj.man_num}减${mj.jian_num};
	                        </c:forEach>
	                        </p>
	                    </div>
            ...
            <div class="tqfooter">
                <div class="ft-lt">
                    ...
                    <div class="price plet" >
                        ...
                        <p class="font6">运费￥<span class="share">${not empty freightList[0].cost?freightList[0].cost:0}起</span></p>
                    </div>
                </div>
