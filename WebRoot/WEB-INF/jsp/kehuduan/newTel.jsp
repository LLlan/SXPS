...
<div class="contentDiv">
    <div class="content">
        <div class="hunbang">
            <input type="text" placeholder="新手机号"name="phone" id="phone" maxlength="11" class="telInput" style="width: 50%" name="mobile"/>
        ...
        <a href="javascript:void(0);" onclick="yanzhou();">确认绑定</a>
    </div>
</div>
<script>
    $(function() {
