package com.yizhan.controller.information.notice;
...
public class NoticeController extends BaseController{
	...
	public ModelAndView headnewslistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=noticeService.headnewslistPage(page);
		mv.addObject("pd", pd);
	...
	public ModelAndView insertHeadNews() throws Exception{
		...
		noticeService.insertHeadNews(pd);
	...
	public ModelAndView updateHeadNews() throws Exception{
		...
		pd=this.getPageData();
		pd.put("addTime", DateUtil.getTime());
		noticeService.updateHeadNews(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteHeadNewsById(PrintWriter writer) throws Exception{
		...
		map.put("ids", ids);
		noticeService.deleteHeadNewsById(map);
		writer.close();
	}
}
